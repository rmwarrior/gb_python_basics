# Домашнее задание для урока 5 первой четверти
...
# Урок 5. Задание 2. * (вместо 1) Решить задачу генерации нечётных чисел от 1 до n (включительно), не используя ключевое слово yield.
